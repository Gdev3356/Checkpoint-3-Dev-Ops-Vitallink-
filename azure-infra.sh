...
echo ""
echo "Uso:"
echo "1. Instale a Azure CLI na sua máquina local"
echo "2. Execute o login:"
echo "az login"
echo "Dê permissão de execução ao script:"
echo "chmod +x azure-infra.sh"
echo "Execute o provisionamento:"
echo "./azure-infra.sh"
echo ""
echo "Próximos passos:"
echo "  1. Acesse a VM via SSH:"
echo "  ssh $ADMIN@<IP_PUBLICO>"
echo "  docker pull seu_usuario/vitallink:v1"
...
echo "  3. Entre na pasta do projeto:"
