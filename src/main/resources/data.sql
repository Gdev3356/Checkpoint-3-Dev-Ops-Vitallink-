...
INSERT INTO TBL_ESPECIALIDADE (NOME, DESCRICAO)
VALUES ('Cardiologia', 'Diagnóstico e tratamento de doenças do coração');

INSERT INTO TBL_ESPECIALIDADE (NOME, DESCRICAO)
VALUES ('Ortopedia', 'Tratamento de lesões e doenças do sistema músculo-esquelético');

-- 2. Médicos (Certifique-se de que os IDs batem com as especialidades acima)
...
-- 3. Pacientes (Apenas UM de cada)
INSERT INTO TBL_PACIENTE (NOME, CPF, EMAIL, TELEFONE, DATA_NASCIMENTO, DATA_CADASTRO)
VALUES ('Carlos Eduardo Silva', '123.456.789-00', 'carlos.silva@email.com', '(11) 98765-4321', DATE '1985-03-15', CURRENT_TIMESTAMP);

INSERT INTO TBL_PACIENTE (NOME, CPF, EMAIL, TELEFONE, DATA_NASCIMENTO, DATA_CADASTRO)
VALUES ('Maria Fernanda Costa', '987.654.321-00', 'maria.costa@email.com', '(11) 91234-5678', DATE '1992-07-22', CURRENT_TIMESTAMP);

INSERT INTO TBL_PACIENTE (NOME, CPF, EMAIL, TELEFONE, DATA_NASCIMENTO, DATA_CADASTRO)
VALUES ('João Pedro Almeida', '456.789.123-00', 'joao.almeida@email.com', '(21) 99876-5432', DATE '1978-11-30', CURRENT_TIMESTAMP);

-- 4. Consultas (Geralmente os IDs gerados pelo banco começam em 1)
